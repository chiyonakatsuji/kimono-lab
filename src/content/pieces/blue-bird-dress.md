...
ja:
  ...
  story: |
    ...
    黒の縮緬地に、松と飛び鶴。裾から斜めに立ちあがる浅葱色の地には、
    宝尽くしの意匠が細かく描かれています。着物のときには裾まわりに
    隠れていた文様を、ドレスでは前身から裾へと流れる線の上に置きました。
...
en:
  ...
  story: |
    *This text is a placeholder — replace it with your mother's own words.*
    ...
    Black silk crêpe, with pine branches and cranes in flight. The
    asagi-blue ground rising diagonally from the hem carries a fine
    takara-zukushi pattern of treasures. On the original kimono these
    motifs sat low, around the feet; here they run up along the line of
    the skirt where they can be seen.

    One shoulder left bare, and the waist cut from the obi cloth itself.
    Because it is made from a single existing kimono, it cannot be
    remade.
---
